...
public class Employee extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3537384723420165446L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Employee\",\"namespace\":\"example.avro\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"sex\",\"type\":\"string\"},{\"name\":\"age\",\"type\":\"int\"},{\"name\":\"address\",\"type\":\"string\"},{\"name\":\"salary\",\"type\":{\"type\":\"record\",\"name\":\"Salary\",\"fields\":[{\"name\":\"netSalary\",\"type\":\"int\"},{\"name\":\"tax\",\"type\":\"int\"}]}}]}");
  ...
  private example.avro.Salary salary;
   ...
   */
  public Employee(java.lang.CharSequence name, java.lang.Integer id, java.lang.CharSequence sex, java.lang.Integer age, java.lang.CharSequence address, example.avro.Salary salary) {
    this.name = name;
    this.id = id;
    this.sex = sex;
    this.age = age;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: salary = (example.avro.Salary)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public example.avro.Salary getSalary() {
    return salary;
  }
   ...
   * @param value the value to set.
   */
  public void setSalary(example.avro.Salary value) {
    this.salary = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Employee>
    ...
    private java.lang.CharSequence address;
    private example.avro.Salary salary;
    private example.avro.Salary.Builder salaryBuilder;
    ...
    private Builder(example.avro.Employee.Builder other) {
      ...
      if (other.hasSalaryBuilder()) {
        this.salaryBuilder = example.avro.Salary.newBuilder(other.getSalaryBuilder());
      }
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.Employee.Builder setSex(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.Employee.Builder clearSex() {
      sex = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.Employee.Builder setSalary(example.avro.Salary value) {
     ...
     * @return This builder.
     */
    public example.avro.Salary.Builder getSalaryBuilder() {
      if (salaryBuilder == null) {
        if (hasSalary()) {
          setSalaryBuilder(example.avro.Salary.newBuilder(salary));
        } else {
          setSalaryBuilder(example.avro.Salary.newBuilder());
        }
      }
    ...
    public example.avro.Employee.Builder setSalaryBuilder(example.avro.Salary.Builder value) {
      clearSalary();
      salaryBuilder = value;
      return this;
    }
      ...
      try {
        ...
        if (salaryBuilder != null) {
          try {
            ...
            e.addParentField(record.getSchema().getField("salary"));
            throw e;
          }
        } else {
          record.salary = fieldSetFlags()[5] ? this.salary : (example.avro.Salary) defaultValue(fields()[5]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.salary == null) {
        this.salary = new example.avro.Salary();
      }
      this.salary.customDecode(in);
